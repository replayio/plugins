...
Use this prompt for the critic side of the build-and-falsify loop. The critic judges whether the worker's Replay recording proves the requirements and the diff.
