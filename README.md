...
| `obvious-ai` | Skills-only Obvious bundle installed to `.obvious/skills/...`, including Replay setup, agent-browser streaming, and direct Replay QA API/project-reuse guidance. |
